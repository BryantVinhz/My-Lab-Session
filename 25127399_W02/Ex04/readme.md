...
- The steps I followed to complete this assignment:
    ...
    - Then, I used the AI agents to iteratively refactor and complete the program based on the approved design
    - Finally I asked the Agent to draw a Mermaid class diagram using a prompt: "Hãy vẽ mermaid ClassDiagram của bài tập trên" and I also reviewed and revised the Mermaid file before completing the assignment
